...
全部 8,170 个村落坐标已通过高德地图API升级为村级/乡镇级精确坐标（地图上显示为大实心圆）。

**当前进度：8,170 / 8,170（100%）已精确** ✅
...
- **村级精确坐标**（`geocode_amap.py` 通过高德地图API逐村查询）— 更精确的定位，目前全部 8,170 条均已升级为此精度

如未来新增村落数据需要补做村级精确地理编码：
