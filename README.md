...
村落坐标正在逐省通过高德地图API升级为村级/乡镇级精确坐标（地图上显示为大实心圆），尚未升级的省份仍使用区县中心坐标（小空心环）。

**当前进度：5,993 / 8,170（73.4%）已精确**

| 状态 | 省份 | 数量 |
|------|------|------|
| ✅ 已精确（26个省/市/区） | 沪、苏、浙、皖、赣、闽、湘、桂、粤、冀、豫、鄂、青、陕、鲁、晋、甘、琼、蒙、新、辽、京、黑、宁、吉、津 | 5,993 |
| ⏳ 待精确（5个省/市/区，西南地区） | 云南省(778)、贵州省(757)、四川省(396)、重庆市(166)、西藏自治区(80) | 2,177 |
